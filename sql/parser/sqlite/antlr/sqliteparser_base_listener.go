...
func (s *BaseSQLiteParserListener) EnterIndex_constraint(ctx *Index_constraintContext) {}

// ExitIndex_constraint is called when production index_constraint is exited.
func (s *BaseSQLiteParserListener) ExitIndex_constraint(ctx *Index_constraintContext) {}
...
func (s *BaseSQLiteParserListener) EnterFunction(ctx *FunctionContext) {}

// ExitFunction is called when production function is exited.
func (s *BaseSQLiteParserListener) ExitFunction(ctx *FunctionContext) {}
...
// ExitArithmetic_expr is called when production arithmetic_expr is exited.
func (s *BaseSQLiteParserListener) ExitArithmetic_expr(ctx *Arithmetic_exprContext) {}
